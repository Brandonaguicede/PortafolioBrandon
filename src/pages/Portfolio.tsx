        ...
        <div style={{ maxWidth: 640, margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, alignItems: "center" }}>
            ...
            <div className="contact-actions" style={{ display: "flex", gap: 16, flexWrap: "wrap", justifyContent: "center" }}>
              ...
              <a href="https://wa.me/85325552" target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 10, border: "1px solid rgba(37,211,102,0.35)", color: "#d1fae5", fontWeight: 700, padding: "12px 24px", borderRadius: 50, fontSize: 15, textDecoration: "none", background: "rgba(37,211,102,0.08)" }}>
